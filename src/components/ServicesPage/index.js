...
export class ServicesPage extends Component {
  ...
  render() {
    ...
    const intro = {
      ...
      text: "Fort Lauderdale Tech Association helps you create and register legal documents, helps track and transfer payments, and acts as an independent arbiter.<br /><br />You decide on a structure (either a loan, a lease-to-own, or a co-investment agreement) and Fort Lauderdale Tech Association takes care of the rest.",
      image: 'services',
    };

    const imageBlockProps = {
      text: 'Let Fort Lauderdale Tech Association take away<br />all the headaches<br />with getting financial <br />support',
      imageClass: 'services',
    };
